...
variable description {
  description = "A description of the managed instance group."
  default     = "Managed Compute Instance Group"
}
...
variable compute_image {
  ...
  default     = "projects/ubuntu-os-cloud/global/licenses/ubuntu-1404-trusty"
}

variable "block_project-ssh-keys" {
  description = "Boolean to enable or disable project-wide ssh key usage."
  type        = "string"
  default     = false
}
...
variable "disk1_source_img" {
  description = "The URL (self_link) of the source image to build this desk from"
  type        = "string"
}
